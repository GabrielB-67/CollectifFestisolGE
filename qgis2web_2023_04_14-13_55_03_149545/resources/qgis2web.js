...
var map = new ol.Map({
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_ListeCollectifFestisolGEliste_collectif_festisol_ge__carto_1,
      colName: 'Ville',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([266082.459110, 5958336.467071, 1280637.442041, 6443386.609835], map.getSize());
